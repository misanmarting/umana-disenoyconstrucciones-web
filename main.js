...
/* ── HERO CINEMATIC REVEAL — CSS animation, no 3D transforms ── */
(function () {
  if (REDUCED) return;
  ...
  requestAnimationFrame(() => requestAnimationFrame(() => {
    h1.style.transitionDelay   = '0.2s';
    sub.style.transitionDelay  = '0.45s';
    ctas.style.transitionDelay = '0.65s';
    [h1, sub, ctas].forEach(el => {
      el.style.opacity   = '1';
